...
_GENERICDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bool', full_name='p4.v1.GenericData.bool', index=2,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='generic_struct', full_name='p4.v1.GenericData.generic_struct', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='generic_list', full_name='p4.v1.GenericData.generic_list', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='generic_unordered_set', full_name='p4.v1.GenericData.generic_unordered_set', index=5,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GENERICUNORDEREDSET = _descriptor.Descriptor(
  name='GenericUnorderedSet',
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='members', full_name='p4.v1.GenericUnorderedSet.members', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GENERICDATA.fields_by_name['generic_unordered_set'].message_type = _GENERICUNORDEREDSET
...
_GENERICDATA.oneofs_by_name['data'].fields.append(
  _GENERICDATA.fields_by_name['generic_unordered_set'])
_GENERICDATA.fields_by_name['generic_unordered_set'].containing_oneof = _GENERICDATA.oneofs_by_name['data']
_GENERICDATA.oneofs_by_name['data'].fields.append(
...
_GENERICUNORDEREDSET.fields_by_name['members'].message_type = _GENERICDATA
...
DESCRIPTOR.message_types_by_name['GenericUnorderedSet'] = _GENERICUNORDEREDSET
...
GenericUnorderedSet = _reflection.GeneratedProtocolMessageType('GenericUnorderedSet', (_message.Message,), {
  'DESCRIPTOR' : _GENERICUNORDEREDSET,
  '__module__' : 'p4.v1.p4data_pb2'
  # @@protoc_insertion_point(class_scope:p4.v1.GenericUnorderedSet)
  })
_sym_db.RegisterMessage(GenericUnorderedSet)

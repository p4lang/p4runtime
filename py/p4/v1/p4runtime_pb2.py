...
_FALLBACKREPLICAS = _descriptor.Descriptor(
  name='FallbackReplicas',
  full_name='p4.v1.FallbackReplicas',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='replicas', full_name='p4.v1.FallbackReplicas.replicas', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MULTICASTGROUPENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='backups', full_name='p4.v1.MulticastGroupEntry.backups', index=3,
      number=4, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FALLBACKREPLICAS.fields_by_name['replicas'].message_type = _REPLICA
_MULTICASTGROUPENTRY.fields_by_name['replicas'].message_type = _REPLICA
_MULTICASTGROUPENTRY.fields_by_name['backups'].message_type = _FALLBACKREPLICAS
...
DESCRIPTOR.message_types_by_name['FallbackReplicas'] = _FALLBACKREPLICAS
...
FallbackReplicas = _reflection.GeneratedProtocolMessageType('FallbackReplicas', (_message.Message,), {
  'DESCRIPTOR' : _FALLBACKREPLICAS,
  '__module__' : 'p4.v1.p4runtime_pb2'
  # @@protoc_insertion_point(class_scope:p4.v1.FallbackReplicas)
  })
_sym_db.RegisterMessage(FallbackReplicas)

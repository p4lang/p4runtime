...
type WriteRequest struct {
	...
	RoleId     uint64   `protobuf:"varint,2,opt,name=role_id,json=roleId,proto3" json:"role_id,omitempty"` // Deprecated: Do not use.
...
func (m *WriteRequest) GetRole() string {
	if m != nil {
		return m.Role
	}
	return ""
...
func (m *ReadRequest) GetRole() string {
	if m != nil {
		return m.Role
	}
	return ""
...
type Role struct {
	...
	Id   uint64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // Deprecated: Do not use.
...
func (m *SetForwardingPipelineConfigRequest) GetRole() string {
	if m != nil {
		return m.Role
	}
	return ""
